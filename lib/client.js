					...
					el('div', { className: 'du-section' },
						...
						oq.status === 'missing-key'
							? el('div', { className: 'du-empty' },
								'OpenCode Go API key not configured — set the DSH_OPENCODE_GO_KEY environment variable (or DEEPSEEK_API_KEY when the deepseek provider uses the OpenCode Go gateway) and restart dsh.')
							: oq.status === 'error'
								? el('div', { className: 'du-empty' },
